      ...
      <html>
        <head>
          ...
          <link
            rel="icon"
            type="image/x-icon"
            href="/_themes/design/img/favicon.ico"
          />
          {extraHead}
        </head>
        <body>
          ...
          <header
            className="header"
            data-toggle-menu="header--overlay"
            data-toggle-search="header--search"
          >
            <div className="wrapper">
              <div className="row">
                <div className="col--main-wide header__row">
                  <a
                    href="http://imdi-no.protolife.no/"
                    className="ident header__ident"
                  >
                    <div className="ident__symbol">
                      ...
                      >
                        <switch>
                          <g>
                            <polygon
                              className="ident__triangle"
                              fill="#F05641"
                              points="87,0 0,87 87,87 "
                            />
                            <polygon
                              fill="#0DAC4B"
                              points="105,105 105,192 192,105 "
                            />
                            <polygon
                              fill="#5CBA5B"
                              points="18,105 105,192 105,105 "
                            />
                            <polygon
                              fill="#FFD666"
                              points="192,105 192,105 105,18 105,105 "
                            />
                          </g>
                          <foreignObject>
                            <img
                    ...
                    <span className="ident__textmark">
                      ...
                      <span className="ident__textmark-secondary">
                        Integrerings- og <br />mangfoldsdirektoratet
                      </span>
                    </span>
                  </a>
                </div>
          ...
          <footer
            className="footer"
            tabIndex={-1}
            data-toggle-menu="footer--overlay"
          >
            <div className="wrapper">
              <div className="row">
                  ...
                  <div className="footer__bg">
                    <div className="footer__row">
                      <div className="footer__main">
                        <nav
                          role="navigation"
                          className="navigation navigation--footer"
                        >
                          ...
                          <ul className="t-no-list-styles">
                            ...
                            <li>
                              <a
                                href="http://imdi-no.protolife.no/sysselsetting-og-arbeidsliv"
                                className="navigation__link navigation__link--primary"
                              >
                            ...
                            <li>
                              <a
                                href="http://imdi-no.protolife.no/fakta-om-integrering"
                                className="navigation__link navigation__link--primary"
                              >
                                Om integrering i Norge
                              </a>
                            </li>
                            <li>
                              <a
                                href="http://imdi-no.protolife.no/tilskudd"
                                className="navigation__link navigation__link--primary"
                              >
                                Tilskudd
                              </a>
                            ...
                            <li>
                              <a
                                href="http://imdi-no.protolife.no/om-oss"
                                className="navigation__link navigation__link--primary"
                              >
                                Om IMDi
                              </a>
                      ...
                      <div className="footer__global">
                        <div className="footer__search">
                          <form action="/sok" method="get" role="search">
                            ...
                            <label
                              ...
                              className="t-only-screenreaders"
                            >
                              Søk nettstedet
                            </label>
                            ...
                            <div className="search search--footer">
                              ...
                              >
                                <i className="icon__search icon--white" />
                                <span className="t-only-screenreaders">
                                  Søk
                                </span>
                              </button>
                            </div>
                        ...
                        <nav
                          role="navigation"
                          className="navigation navigation--footer footer__submenues"
                        >
                          ...
                          <div className="footer__submenu">
                            <ul className="t-no-list-styles">
                              <li>
                                <a
                                  href="http://imdi-no.protolife.no/om-oss/kontakt-oss"
                              ...
                              <li>
                                <a
                                  href="http://imdi-no.protolife.no/om-oss/arrangementer"
                                  className="navigation__link"
                                >
                              ...
                              <li>
                                <a
                                  href="http://imdi-no.protolife.no/om-oss/rapporter"
                                  className="navigation__link"
                                >
                                  Rapporter
                                </a>
