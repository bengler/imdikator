...
function generateCustomEvent(action, state) {
  ...
  switch (action.type) {
    ...
    case TRACK_EVENT_BACKGROUND_OPEN:
      return Object.assign({}, event, {eventCategory: 'iFakta Options opened', eventAction: 'Bakgrunn'})
    case TRACK_EVENT_GENDER_OPEN:
      return Object.assign({}, event, {eventCategory: 'iFakta Options opened', eventAction: 'Kjønn'})
    case TRACK_EVENT_UNIT_OPEN:
      return Object.assign({}, event, {eventCategory: 'iFakta Options opened', eventAction: 'Enhet'})
