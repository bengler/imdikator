...
function generateCustomEvent(action, state) {
  ...
  switch (action.type) {
    ...
    case TRACK_EVENT_BENCHMARK_TAB_OPEN:
      return Object.assign({}, event, {eventCategory: 'iFakta Views', eventAction: 'Sammenliknet'})
    ...
    case TRACK_EVENT_YEAR_CHANGED:
      return Object.assign({}, event, {eventCategory: 'iFakta Filtered', eventAction: 'År'})
    case TRACK_EVENT_BACKGROUND_CHANGED:
      return Object.assign({}, event, {eventCategory: 'iFakta Filtered', eventAction: 'Bakgrunn'})
    case TRACK_EVENT_GENDER_CHANGED:
      return Object.assign({}, event, {eventCategory: 'iFakta Filtered', eventAction: 'Kjønn'})
    case TRACK_EVENT_UNIT_CHANGED:
      return Object.assign({}, event, {eventCategory: 'iFakta Filtered', eventAction: 'Enhet'})
    case TRACK_EVENT_OTHER_FILTERS_CHANGED:
      return Object.assign({}, event, {eventCategory: 'iFakta Filtered', eventAction: 'Annet'})
