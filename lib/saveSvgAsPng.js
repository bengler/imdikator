...
(function() {
  ...
  function inlineImages(el, callback) {
    ...
    console.log(36, { images, left, checkDone });

    checkDone();
    console.log(39, 'checkDone');
    for (var i = 0; i < images.length; i++) {
      (function(image) {
        ...
        console.log(55, { canvas, ctx, img, href });
        if (href) {
          img.src = href;
          img.onload = function() {
        ...
        for (var j = 0, match; j < rules.length; j++, match = null) {
          ...
          if (typeof rule.style != 'undefined') {
            ...
            try {
              if (selectorText) {
                match =
                  el.querySelector(selectorText) ||
                  (el.parentNode && el.parentNode.querySelector(selectorText));
              }
            } catch (err) {
            ...
            if (match) {
              var selector = selectorRemap
                ...
                : rule.selectorText;
              var cssText = modifyStyle
                ? modifyStyle(rule.style.cssText)
                : rule.style.cssText;
  ...
  out$.svgAsPngUri = function(el, options, cb) {
    ...
    var convertToPng = function convertToPng(src, w, h) {
      ...
      if (options.canvg) {
        console.log('svg source data', src);
  ...
  out$.download = function(name, uri) {
    if (navigator.msSaveOrOpenBlob) {
      ...
      console.log(438, { saveLink, downloadSupported });
      if (downloadSupported) {
        ...
        if (navigator.msSaveBlob) {
          ...
          console.log(navigator.msSaveBlok(uri, name));
