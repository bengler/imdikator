import {getHeaderKeyNames, prefixify} from './regionUtil'
...
function normalizeRegionId(object) {
  ...
  const withoutHeaderKeys = reject(object, HEADER_KEYS)
  ...
  return Object.assign({}, withoutHeaderKeys, {
    [headerKey]: prefixify(headerKey, object[headerKey])
  })
...
export function queryResultPresenter(query, result, config) {
  ...
  // Regions
  if (query.region || query.comparisonRegions) {
